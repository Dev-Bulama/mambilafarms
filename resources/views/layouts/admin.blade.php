...
:root{
  --pk:#FF5487;--pkd:#D81B7A;--gn:#8DC63F;
  --bg:#0a0610;--card:#130d1a;--card2:#1a1024;--border:rgba(255,255,255,.07);
  --t1:#f0eaf5;--t2:rgba(240,234,245,.5);--t3:rgba(240,234,245,.22);
  --sidebar:220px;
}
body{font-family:'Plus Jakarta Sans',sans-serif;background:var(--bg);color:var(--t1);display:flex;min-height:100vh}
...
.sb-nav{flex:1;padding:1rem .75rem;display:flex;flex-direction:column;gap:.15rem}
...
.topbar{padding:.85rem 1.75rem;border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between;background:var(--card);position:sticky;top:0;z-index:50}
